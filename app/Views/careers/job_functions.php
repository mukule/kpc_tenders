...
<div class="container p-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <h2>Job Functions</h2>
        <a href="<?= base_url('/vacancyfunctions/create') ?>" class="btn btn-primary">
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('vacancyfunctions/edit/' . $function['id']) ?>" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="<?= base_url('vacancyfunctions/delete/' . $function['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">
